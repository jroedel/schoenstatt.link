...
if ($inDevelopment) {
    ...
    $csp = "default-src 'none'; script-src 'self' 'nonce-{:nonce}' 'report-sample'; img-src 'self' data:; style-src 'self' 'sha256-vHSqqVrJZ5Qsgn51E6GCa6KthouKZttn9iJIjW7FpsY=' 'sha256-43LT1ORp2cNKCkTTWnjODmQQz1f0cDG/9/QwP7+B2EE='; connect-src 'self'; font-src 'self'; base-uri 'none'; form-action 'self'; frame-ancestors 'none'; report-uri http://schoenstatt.localhost/csp-report.php;";
} else {
    $csp = "default-src 'none'; script-src 'self' 'nonce-{:nonce}' 'report-sample'; img-src 'self'; style-src 'self'; connect-src 'self'; font-src 'self'; base-uri 'none'; form-action 'self'; frame-ancestors 'none'; report-uri https://schoenstatt.link/csp-report.php;";
}
