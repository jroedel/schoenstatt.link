...
namespace Books\OpenUrl;

// Absorbed from talis/niso-openurl (MIT license, https://github.com/jroedel/php-niso-openurl)
// when the upstream repo was deleted from GitHub; namespace changed from OpenURL.
...
class ContextObject
{
     ...
     * @var array
     */
    protected $entityMap = ["rft" => "referent", "rfr" => "referrer","rfe" => "referringEntity","req" => "requester","svc" => "serviceType","res" => "resolver"];
    ...
    protected function setEntityMetadata($key, $value)
    {
        ...
        if ($entity == "svc" || $entity == "res") {
            ...
            if (! ($this->$entityName instanceof Entity)) {
    ...
    /**
     * @param Entity $referent
     */
    public function setReferent(Entity $referent)
    {
     ...
     */
    public function setReferrer(Entity $referrer)
    {
     ...
     */
    public function setReferringEntity(Entity $referringEntity)
    {
     ...
     */
    public function setRequester(Entity $requester)
    {
     ...
     */
    public function addServiceType(Entity $serviceType)
    {
     ...
     */
    public function addResolver(Entity $resolver)
    {
    ...
    {
        $kevs = ['url_ver=Z39.88-2004', 'url_ctx_fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Actx'];
