...
//     	        break;
    	    ...
    	    default:
    	       ...
    	       $finalMarkup .= $this->view->formatScope($assignment['baseScope'], $assignment['scopeName'],
    	           $assignment['scopeId']);
    	    break;
    	}
    	echo ' ';
    	...
    	if ($assignment['startDate']) {
    	    $finalMarkup .= ' '.$this->view->translate("starting").' '.$this->view->dateFormat($assignment['startDate'], \IntlDateFormatter::SHORT, \IntlDateFormatter::NONE);
    	}
    	if ($assignment['endDate']) {
    	    $finalMarkup .= ' '.$this->view->translate("until").' '.$this->view->dateFormat($assignment['endDate'], \IntlDateFormatter::SHORT, \IntlDateFormatter::NONE);
    	}
