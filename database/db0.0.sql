...
ALTER TABLE `sch_changes`
  ...
  CREATE TABLE `jk`.`sch_associations` ( `AssociationId` INT NOT NULL AUTO_INCREMENT , `AssociationName` VARCHAR(200) NOT NULL , `Parent` INT NULL DEFAULT NULL , `Kind` VARCHAR(50) NOT NULL , `FoundationDate` DATE NULL DEFAULT NULL , `SuppressionDate` DATE NULL DEFAULT NULL , `IsLifeCommunity` BOOLEAN NOT NULL DEFAULT FALSE , `IsNameTranslateable` BOOLEAN NOT NULL DEFAULT FALSE , `IsActive` BOOLEAN NOT NULL DEFAULT TRUE , `PublicNotes` TEXT NULL DEFAULT NULL , `PublicNotesUpdatedOn` DATETIME NULL DEFAULT NULL , `PublicNotesUpdatedBy` INT NULL DEFAULT NULL , `AdminNotes` TEXT NULL DEFAULT NULL , `AdminNotesUpdatedOn` DATETIME NULL DEFAULT NULL , `AdminNotesUpdatedBy` INT NULL DEFAULT NULL , `Email` VARCHAR(200) NULL DEFAULT NULL , `Email2` INT(200) NULL DEFAULT NULL , `EmailsUpdatedOn` DATETIME NULL DEFAULT NULL , `EmailsUpdatedBy` INT NULL DEFAULT NULL , `Phone1` VARCHAR(70) NULL DEFAULT NULL , `Phone1Label` VARCHAR(50) NULL DEFAULT NULL , `Phone2` VARCHAR(70) NULL DEFAULT NULL , `Phone2Label` VARCHAR(50) NULL DEFAULT NULL , `Phone3` VARCHAR(70) NULL DEFAULT NULL , `Phone3Label` VARCHAR(50) NULL DEFAULT NULL , `PhonesUpdatedOn` DATETIME NULL DEFAULT NULL , `PhonesUpdatedBy` INT NULL DEFAULT NULL , `Url1` VARCHAR(1000) NULL DEFAULT NULL , `Url1Label` VARCHAR(50) NULL DEFAULT NULL , `Url2` VARCHAR(1000) NULL DEFAULT NULL , `Url2Label` VARCHAR(50) NULL DEFAULT NULL , `Url3` VARCHAR(1000) NULL DEFAULT NULL , `Url3Label` VARCHAR(50) NULL DEFAULT NULL , `FacebookUrl` VARCHAR(1000) NULL DEFAULT NULL , `TwitterUser` VARCHAR(50) NULL DEFAULT NULL , `InstagramUser` VARCHAR(50) NULL DEFAULT NULL , `ContactNotes` VARCHAR(1000) NULL DEFAULT NULL , `ContactInfoUpdatedOn` DATETIME NULL DEFAULT NULL , `ContactInfoUpdatedBy` INT NULL DEFAULT NULL , `UpdatedOn` DATETIME NULL DEFAULT NULL , `UpdatedBy` INT NULL DEFAULT NULL , `CreatedOn` DATETIME NULL DEFAULT NULL , `CreatedBy` INT NULL DEFAULT NULL , PRIMARY KEY (`AssociationId`)) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
  ALTER TABLE `sch_associations` ADD `Country` VARCHAR(3) NULL DEFAULT NULL AFTER `Kind`;
  ALTER TABLE `sch_associations` ADD `AdminTags` INT(255) NULL DEFAULT NULL AFTER `PublicNotesUpdatedBy`;
