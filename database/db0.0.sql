...
ALTER TABLE `sch_roles`
  ...
  CREATE TABLE `sch_persons` ( `PersonId` INT NOT NULL AUTO_INCREMENT , `LastName` VARCHAR(100) NOT NULL , `FirstName` VARCHAR(100) NOT NULL , `LastNameWithoutAccents` VARCHAR(100) NOT NULL , `FirstNameWithoutAccents` VARCHAR(100) NOT NULL , `ReligiousStatus` VARCHAR(50) NULL DEFAULT 'Lay' , `Title` VARCHAR(10) NULL DEFAULT NULL , `TitleAutomatic` BOOLEAN NOT NULL DEFAULT TRUE , `Country` VARCHAR(3) NULL DEFAULT NULL , `BirthDate` DATE NULL DEFAULT NULL , `NameDay` DATE NULL DEFAULT NULL , `DeaconDate` DATE NULL DEFAULT NULL , `PriestDate` DATE NULL DEFAULT NULL , `BishopDate` DATE NULL DEFAULT NULL , `DeathDate` DATE NULL DEFAULT NULL , `LeaveDate` DATE NULL DEFAULT NULL , `PublicNotes` TEXT NULL DEFAULT NULL , `PublicNotesUpdatedOn` DATETIME NULL DEFAULT NULL , `PublicNotesUpdatedBy` INT NULL DEFAULT NULL , `PersonalInfoUpdatedOn` DATETIME NULL DEFAULT NULL , `PersonalInfoUpdatedBy` INT NULL DEFAULT NULL , PRIMARY KEY (`PersonId`)) ENGINE = InnoDB CHARACTER SET utf8 COLLATE utf8_general_ci;
