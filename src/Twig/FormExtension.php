 ...
 *
 * Every one of them returns markup, so every one is declared `is_safe: html`. Twig
 * autoescaping is on (see App\Twig\TwigFactory) and without the declaration the
 * whole form arrives on screen as escaped source.
 *
 * The rendering itself is App\Form\BootstrapFormRenderer's; this class is only the
 * Twig binding.
 */
