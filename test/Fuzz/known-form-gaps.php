...
return [
    ...
    'deadElementKeys' => [
        'module/Schoenstatt/src/Form/PersonForm.php:505 element \'publicNotes\' carries a dead \'filters\' key in its element definition',
    ],
    ...
    'validationSuppliedOnlyByElement' => [
        ...
        'Books\\Form\\CompositionForm: \'copyrightContactEmail\' is validated by Regex, which the input filter spec does not declare',
        ...
        'Books\\Form\\LibraryForm: \'contactEmail\' is validated by Regex, which the input filter spec does not declare',
        ...
        'JUser\\Form\\LoginForm: \'email\' is validated by Regex, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AdvancedSearchForm: \'roleTitle\' is validated by Explode, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssignmentForm: \'endDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssignmentForm: \'startDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssociationForm: \'email\' is validated by Regex, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssociationForm: \'facebookUrl\' is validated by Uri, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssociationForm: \'foundationDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        ...
        'Schoenstatt\\Form\\AssociationForm: \'url1\' is validated by Uri, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssociationForm: \'url2\' is validated by Uri, which the input filter spec does not declare',
        'Schoenstatt\\Form\\AssociationForm: \'url3\' is validated by Uri, which the input filter spec does not declare',
        'Schoenstatt\\Form\\EditAssignmentForm: \'endDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\EditAssignmentForm: \'startDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\ImportFatherForm: \'personId\' is validated by InArray, which the input filter spec does not declare',
        'Schoenstatt\\Form\\PersonForm: \'birthDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\PersonForm: \'bishopDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\PersonForm: \'deathDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
        'Schoenstatt\\Form\\PersonForm: \'email\' is validated by Regex, which the input filter spec does not declare',
        'Schoenstatt\\Form\\PersonForm: \'email2\' is validated by Regex, which the input filter spec does not declare',
        ...
        'Schoenstatt\\Form\\PersonForm: \'priestDate\' is validated by Date, GreaterThan, which the input filter spec does not declare',
